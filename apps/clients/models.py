...
class Order(AbstractBaseModel):
    tenant = models.ForeignKey("tenants.Tenant", on_delete=models.CASCADE)
    client = models.ForeignKey(Client, on_delete=models.CASCADE, related_name="clientorders")
    order_number = models.CharField(max_length=255)
    customer_name = models.CharField(max_length=255)
    customer_phone = models.CharField(max_length=255)
    customer_location = models.JSONField(null=True)
    customer_address = models.CharField(max_length=500)
    order_status = models.CharField(max_length=255, choices=ORDER_STATUSES, default="Pending Dispatch")
...
class OrderStatusUpdate(AbstractBaseModel):
    order = models.ForeignKey(Order, on_delete=models.CASCADE, related_name="orderstatuses")
